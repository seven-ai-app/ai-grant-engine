...
class GrantState(TypedDict):
    ...
    # === Structured Tables (generated by technical_writer) ===
    rd_tasks: list[dict]          # [{"task_name": str, "description": str, "start_mm_yy": str, "end_mm_yy": str}]
    capability_table: list[dict]  # [{"capability": str, "current_state": str, "target_state": str}]
    competitor_table: list[dict]  # [{"name": str, "url": str, "features": str, "price": str, "market_share": str}]
